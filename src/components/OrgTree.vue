    ...
    <div v-if="show" style="width:100%;height:100%">
        ...
        <div class="chan_center">
            ...
            <div class="chan_center_body" ref="scrollArea">
                <div v-for="(row, idx) in orglist" class="org_body" @mouseenter="rowEnter(row)" @mouseleave="rowLeave(row)">
...
<style scoped>
    ...
    .org_body {
        width:100%;display:flex;flex-direction:column;border:1px solid lightgray;cursor:pointer
    }
    .item {  				
